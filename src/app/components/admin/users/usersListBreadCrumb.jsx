...
const UsersListBreadCrumb = ({ setCurrentFilter, setSearchValue }) => {
  // const csvData = [
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-between gap-5 rounded-lg bg-btpurple bg-opacity-10 px-3 py-5 md:flex-row md:py-2">
        <div className="flex flex-col items-center gap-5 md:flex-row">
          <Searchbox placeholder="Search users" setSearch={setSearchValue} />
        ...
        <div className="flex items-center  gap-5">
          <div className="flex items-center gap-5">
            ...
            <FilterDropDown
              ...
              options={["Web Developer", "Andriod Developer"]}
            />
            {/* <input
              type="date"
