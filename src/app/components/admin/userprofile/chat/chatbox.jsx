...
const Chatbox = () => {
  return (
    <div className="relative h-[95vh] flex flex-col rounded-xl overflow-hidden shadow-lg">
      ...
      <div
        className="p-4 my-16 flex-grow bg-white"
        style={{
          overflow: "auto",
      ...
      >
        ...
        {/*  <Chat type={"receiver"} message={"Hello, How're you 👋"} time={"7:40 PM"}/>
                <Chat type={"sender"} message={"I'm doing great and you?"} time={"6:40 PM"}/> */}
      </div>
